...
exports.getUserFamilies = async (req, res) => {
  try {
    ...
    // Ensure we have a valid array of families - THIS IS THE PROBLEM
    // The results might not be an array in some cases
...
exports.getFamilyById = async (req, res) => {
  try {
    ...
    // Then check if user is a member of this family
