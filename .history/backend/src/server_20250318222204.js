...
app.use('/api/families/:familyId/events', (req, res, next) => {
  console.log('Family Event Route - familyId:', req.params.familyId);
  next();
}, familyEventRoutes);
...
app.param('familyId', (req, res, next, id) => {
  console.log('familyId param middleware called with:', id);
  console.log('Before setting params:', req.params);
  req.params.familyId = id;
  console.log('After setting params:', req.params);
  next();
});
