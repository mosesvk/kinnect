...
describe('Media Controller', () => {
  ...
  describe('uploadMedia', () => {
    test('uploads media successfully', async () => {
      ...
      // Run the middleware directly to test the controller
      const middleware = (req, res, next) => upload.single('file')(req, res, next);
      
      // Call middleware to simulate route handling
