// Additional test cases to complete the Event Controller test file
...
// Then import the controller and models
...
describe("edge cases and error handling", () => {
  ...
  test("validates startDate is before endDate", async () => {
    ...
    // Assuming the controller has date validation logic
    // If it doesn't, this test would need to be modified or removed

    // Call the controller
    await eventController.createEvent(req, res);

    // Assertions would depend on how your controller handles this case
    // If it doesn't have built-in validation for this, the test should be skipped
    // or altered to test the validation middleware instead
  });
});
