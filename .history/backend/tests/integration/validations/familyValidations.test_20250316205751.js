...
app.post('/test/family-create', validateWithFormat(validateFamilyCreation), (req, res) => {
  res.json({ success: true, data: req.body });
});

app.put('/test/family-update', validateWithFormat(validateFamilyUpdate), (req, res) => {
  res.json({ success: true, data: req.body });
});

app.post('/test/family-member-add', validateWithFormat(validateFamilyMemberAddition), (req, res) => {
  res.json({ success: true, data: req.body });
});
